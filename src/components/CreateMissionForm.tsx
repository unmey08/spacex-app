    ...
    <div className="w-full h-full">
      ...
      <div className="md:flex justify-evenly sm:block">
        ...
        {/* <svg
          ...
          xmlSpace="preserve"
          stroke="#432dd7"
          className="self-center justify-self-center w-1/2 h-1/2 md:w-1/4 md:h-1/4 p-10"
        >
